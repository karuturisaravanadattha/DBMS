...
AND salary = (select max(salary) from employee where department = 'Testing');

SELECT id , name,salary,department from employee where department = 'HR'
AND salary = (select max(salary) from employee where department = 'HR');

SELECT id , name,salary,department from employee where department = 'SW'
AND salary = (select max(salary) from employee where department = 'SW');

SELECT id , name,salary,department from employee where department = 'Operations'
AND salary = (select max(salary) from employee where department = 'Operations');
...
select id,name,salary,department,date_of_joining  from employee
where ( department,date_of_joining ) IN
(select department, max(date_of_joining)  From employee
where department is not null
group by department)
