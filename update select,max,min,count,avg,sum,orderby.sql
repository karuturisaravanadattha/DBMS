...
SELECT name,age,salary+25000 as new_salary FROM employee;

SELECT name,department,gender from employee WHERE department = 'HR';

SELECT id,name,date_of_joining,department,gender FROM employee  WHERE gender = 'FEMALE';

SELECT name,salary,department FROM employee WHERE gender = 'MALE' AND department = 'SW' AND salary > 50000;

SELECT id,name,email,date_of_joining FROM employee WHERE date_of_joining IS NULL;

SELECT id,name,age,gender,department,salary,date_of_joining,email FROM employee WHERE department = 'SW' AND date_of_joining > TO_DATE('01-01-2020','MM-DD-YYYY');

SELECT id,name,email,department FROM employee WHERE email IS NULL AND department IS NULL;

SELECT id, name, gender, department, salary, date_of_joining FROM employee WHERE gender = 'MALE' AND salary <=40000 AND date_of_joining = TO_DATE('15-07-2021','DD-MM-YYYY');
...
--Aggregate Functions,
--Used to find the sum of all the values
...
--COUNT()
--count is used to give how many
--find out how many employee are working under HR

SELECT COUNT(department) FROM employee
WHERE department = 'HR';

--using COUNT with column name does not count NULL
SELECT COUNT(department) FROM employee;
...
--Find out how many female employee are working in operations department
SELECT COUNT(name) FROM employee
WHERE department = 'Operations'
AND gender = 'Female';

--Findout for how many employees the email is missing
SELECT COUNT(email) FROM employee WHERE email IS NULL;

--Findout how many employees joined in Testing department after 12-07-2019
...
--find maxi name (based on alphabet) from HR
